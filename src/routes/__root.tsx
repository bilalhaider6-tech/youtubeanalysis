...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Free, fast, and compliant tools to grow your channel: thumbnails, SEO, embeds, and analytics." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@tubepilot" },
      { name: "twitter:title", content: "TubePilot — The Premium Toolkit for YouTube Creators" },
      { name: "twitter:description", content: "Free, fast, and compliant tools to grow your channel." },
    ],
    links: [
